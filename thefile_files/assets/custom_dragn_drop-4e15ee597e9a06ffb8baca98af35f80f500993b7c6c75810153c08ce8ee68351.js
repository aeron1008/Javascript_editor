      ...
      if (draggable && draggable.getAttribute("name")) {
        ...
        switch (element) {
          case "headline-field":
            ...
            rolloverTools2.appendChild(moveButton);
            rolloverTools2.appendChild(advanceButton);
            rolloverTools2.appendChild(cloneButton);
            rolloverTools2.appendChild(removeButton);
            rolloverTools2.appendChild(arrowUpButton);
            rolloverTools2.appendChild(arrowDownButton);
            rolloverTools2.appendChild(settingsButton);
            rolloverTools2.appendChild(headlineText);
            rolloverTools2.appendChild(plusCircle);
