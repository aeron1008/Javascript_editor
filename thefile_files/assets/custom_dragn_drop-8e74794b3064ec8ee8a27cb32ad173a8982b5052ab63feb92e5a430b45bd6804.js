  ...
  function CustomDragAndDrop() {
    ...
    this.onDragStart = function(e, draggable) {
      ...
      if (draggable && draggable.getAttribute("name")) {
        ...
        switch (element) {
          case "headline-field":
            let createRolloverButton2 = function(iconClass) {
              var button = document.createElement("div");
              button.classList.add("de-rollover-button");
              button.innerHTML = '<i class="' + iconClass + '"></i>';
              return button;
            }, createRolloverText2 = function(text) {
              var textElement2 = document.createElement("div");
              textElement2.classList.add("de-rollover-text");
              textElement2.textContent = text;
              return textElement2;
            }, handleMouseOver2 = function() {
              rolloverTools.style.display = "block";
              wrapper.style.borderColor = "orange";
              wrapper.style.borderWidth = "3px";
            }, handleMouseOut2 = function() {
              rolloverTools.style.display = "none";
              wrapper.style.borderColor = "";
              wrapper.style.borderWidth = "";
            };
            var createRolloverButton = createRolloverButton2, createRolloverText = createRolloverText2, handleMouseOver = handleMouseOver2, handleMouseOut = handleMouseOut2;
            ...
            var moveButton = createRolloverButton2("fa fa-arrows");
            var advanceButton = createRolloverButton2("fa fa-cog");
            var cloneButton = createRolloverButton2("fa fa-copy");
            var removeButton = createRolloverButton2("fa fa-trash-o");
            var arrowUpButton = createRolloverButton2("fa fa-arrow-up");
            var arrowDownButton = createRolloverButton2("fa fa-arrow-down");
            var settingsButton = createRolloverButton2("fa fa-cogs");
            var headlineText = createRolloverText2("HEADLINE");
            var plusCircle = createRolloverButton2("fa fa-plus-circle");
            rolloverTools.appendChild(moveButton);
            rolloverTools.appendChild(advanceButton);
            rolloverTools.appendChild(cloneButton);
            rolloverTools.appendChild(removeButton);
            var leftTopButtons = document.createElement("div");
            leftTopButtons.classList.add(
              "d-flex",
              "justify-content-start",
              "mb-2"
            );
            leftTopButtons.appendChild(arrowUpButton);
            leftTopButtons.appendChild(arrowDownButton);
            leftTopButtons.appendChild(settingsButton);
            rolloverTools.appendChild(leftTopButtons);
            rolloverTools.appendChild(headlineText);
            var centeredPlus = document.createElement("div");
            centeredPlus.classList.add("d-flex", "justify-content-center");
            centeredPlus.appendChild(plusCircle);
            rolloverTools.appendChild(centeredPlus);
            wrapper.appendChild(elementToInsert);
            wrapper.appendChild(rolloverTools);
            wrapper.addEventListener("mouseover", handleMouseOver2);
            wrapper.addEventListener("mouseout", handleMouseOut2);
