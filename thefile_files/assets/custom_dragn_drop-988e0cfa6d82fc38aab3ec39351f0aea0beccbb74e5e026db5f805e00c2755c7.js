(() => {
  ...
  function CustomDragAndDrop() {
      ...
      if (draggable && draggable.getAttribute("name")) {
        ...
        switch (element) {
          case "headline-field":
            ...
            wrapper.classList.add("draggable", "de", "elHeadlineWrapper", "ui-droppable", "de-editable");
            ...
            elementToInsert.classList.add("ne", "elHeadline", "fs-1", "lh4", "elMargin0", "elBGStyle0", "hsTextShadow0", "display-5", "font-weight-normal");
          ...
          case "subhead-field":
            ...
            subheadWrapper.classList.add("draggable", "de", "elSubHeadlineWrapper", "ui-droppable", "de-editable");
            ...
            subheadElement.classList.add("ne", "elSubHeadline", "hsSize3", "lh4", "elMargin0", "elBGStyle0", "hsTextShadow0");
          ...
          case "paragraph-field":
            ...
            paragraphWrapper.classList.add("draggable", "de", "elparagraphWrapper", "ui-droppable", "de-editable");
            ...
            textElement.classList.add("ne", "elText", "hsSize3", "lh4", "elMargin0", "elBGStyle0", "hsTextShadow0");
          ...
          case "countdown-field":
            ...
            const formattedTargetDateMessage = `Hurry! This special offer is available until ${getFormattedDate2(currentDate)}`;
          ...
          case "input-field":
            ...
            inputWrapper.classList.add("draggable", "de", "elInputWrapper", "de-editable", "de-input-block", "elAlign_center", "elMargin0");
          ...
          case "email-field":
            ...
            emailWrapper.classList.add("draggable", "de", "elemailWrapper", "de-editable", "de-input-block", "elAlign_center", "elMargin0");
            ...
            emailElement.classList.add("elInput", "elInput100", "elAlign_left", "elInputMid", "elInputStyl0", "elInputBG1", "elInputBR5", "elInputI0", "elInputIBlack", "elInputIRight", "required0", "ceoinput");
    ...
    this.addEventListenerForDraggableItem = function(element) {
      ...
      const elHeadlineElements = element.querySelectorAll(".elHeadline, .elText, .elSubHeadline");
