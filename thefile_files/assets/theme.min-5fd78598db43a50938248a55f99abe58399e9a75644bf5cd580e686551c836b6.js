  ...
  $(document).off().on("ready turbolinks:load", function() {
    ...
    !function() {
      ...
      $(".course-list").length && $(".course-list").slimScroll({
        ...
        height: "97%"
      }), $(".dropdown-menu a.dropdown-toggle").length && $(".dropdown-menu a.dropdown-toggle").on("click", function(e2) {
        return $(this).next().hasClass("show") || $(this).parents(".dropdown-menu").first().find(".show").removeClass("show"), $(this).next(".dropdown-menu").toggleClass("show"), $(this).parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown", function(e3) {
        ...
        var e2 = function(e3) {
          var t2 = 0;
          6 <= e3.length && (t2 += 1);
          e3.match(/([a-z].*[A-Z])|([A-Z].*[a-z])/) && (t2 += 1);
          e3.match(/([a-zA-Z])/) && e3.match(/([0-9])/) && (t2 += 1);
          return t2;
        }($(this).val()), t = $(this).parent(".password-field");
        t.removeClass(function(e3, t2) {
      ...
      }, new ApexCharts(document.querySelector("#payoutChart"), e).render()), $("#editor").length && new Quill("#editor", {
        theme: "snow"
      ...
      }), $("#nav-toggle").length && $("#nav-toggle").on("click", function(e2) {
        e2.preventDefault(), $("#db-wrapper").toggleClass("toggled");
      }), $("#invoice").length && $("#invoice").find(".print-link").on("click", function() {
        $.print("#invoice");
      }), $(".sidebar-nav-fixed a").length && $(".sidebar-nav-fixed a").on("click", function(e2) {
        var t;
        location.pathname.replace(/^\//, "") != this.pathname.replace(/^\//, "") || location.hostname != this.hostname || (t = (t = $(this.hash)).length ? t : $("[name=" + this.hash.slice(1) + "]")).length && (e2.preventDefault(), $("html, body").animate({
          scrollTop: t.offset().top - 90
        }, 1e3, function() {
          var e3 = $(t);
          if (e3.focus(), e3.is(":focus"))
            return false;
          e3.attr("tabindex", "-1"), e3.focus();
      ...
      }), $(".stopevent").length && $(document).on("click.bs.dropdown.data-api", ".stopevent", function(e2) {
        e2.stopPropagation();
      }), $("input[name=tags]").length && (e = document.querySelector("input[name=tags]"), new Tagify(e)), $(".headingTyped").length && new Typed(".headingTyped", {
      ...
      $(e).on("change", function() {
        true === $(e).is(":checked") ? $(".toggle-price-content").each(function() {
    ...
    function() {
      ...
      }).parentsUntil(".sidebar-nav").each(function(e2) {
